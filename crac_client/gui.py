        ...
        block_stato_crac = [
            ...
            [
                sg.Column(layout=([
                    [
                        sg.Frame(layout=([
                            [sg.Text('  ', size=(11, 1), justification='center', font=("Helvetica", 12))],
                            [
                        ...
                        sg.Frame(layout=(
                            [sg.Text('Ovest', size=(11, 1), justification='center', font=("Helvetica", 12)), sg.Text('Est', size=(11, 1), justification='center', font=("Helvetica", 12))],
                            [
            ...
            [sg.Text(GuiLabel.NO_ALERT.value, size=(60, 1), justification='center', background_color="#B0C4DE", font=("Helvetica", 12), text_color="#FF0000", key="alert", relief=sg.RELIEF_RIDGE)]
        ]
